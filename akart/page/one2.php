                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/one/oneplus2-main.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/one/images.jpg" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/one/one-two.jpg" alt="Home applicances">
                                </div>
                            </div>
