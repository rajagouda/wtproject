                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/e5/1.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/e5/2.jpg" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/e5/3.jpg" alt="Home applicances">
                                </div>
                            </div>
