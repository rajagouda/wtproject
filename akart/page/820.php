                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/820/1.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/820/2.jpg" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/820/3.jpg" alt="Home applicances">
                                </div>
                            </div>
