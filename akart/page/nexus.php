                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/nexus/1.png" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/nexus/2.png" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/nexus/3.png" alt="Home applicances">
                                </div>
                            </div>
