                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="./img/mobile_sale.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="./img/camera_sale.jpg" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="./img/ha_sale.jpg" alt="Home applicances">
                                </div>
                            </div>
