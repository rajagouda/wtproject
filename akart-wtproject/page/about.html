                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/iphone/1.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/iphone/2.png" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/iphone/3.jpg" alt="Home applicances">
                                </div>
                            </div>
