                            ...
                            <ol class="carousel-indicators">
                             ...
                             <div class="carousel-inner" style="max-height:400px; min-height:400px;">
                                <div class="item active">
                                    <img class="slide-image" src="../images/e5/1.jpg" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/e5/2.jpg" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/e5/3.jpg" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;" alt="Home applicances">
                                </div>
                            </div>
...
<div="row">
    ...
    <div id="image" >
    <h1>Samsung Galaxy E5 16GB</h1> 
        <img src="../images/spec/e5.png">
    </div>
...
<div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="e5.php">
                              </div>
