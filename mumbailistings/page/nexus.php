                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" style="max-height:400px; min-height:400px;">
                                <div class="item active">
                                    <img class="slide-image" src="../images/nexus/1.png" alt="mobile" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;"> 
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/nexus/2.png" alt="camera" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/nexus/3.png" alt="Home applicances" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
...
<div="row">
    ...
    <div id="image" >
    <h1>Google Nexus 5</h1> 
        <img src="../images/spec/nexus.png">
    </div>
...
<div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="nexus.php">
                              </div>
