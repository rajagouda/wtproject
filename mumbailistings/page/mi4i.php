                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" style="max-height:400px; min-height:400px;">
                                <div class="item active">
                                    <img class="slide-image" src="../images/mi4i/1.jpg" alt="mobile" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/mi4i/2.jpg" alt="camera" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/mi4i/3.jpg" alt="Home applicances" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                            </div>
...
<div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="mi4i.php">
                              </div>
