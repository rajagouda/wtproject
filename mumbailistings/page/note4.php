                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" style="max-height:400px; min-height:400px;">
                                <div class="item active">
                                    <img class="slide-image" src="../images/n5/1.jpg" alt="mobile" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/n5/2.jpg" alt="camera" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/n5/3.jpg" alt="Home applicances" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;">
                                </div>
                            </div>
...
<div="row">
     ...
     <div id="image" >
    <h1>Samsung Note 5 32GB White</h1> 
        <img src="../images/spec/note5.png">
    </div>
...
<div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="note4.php">
                              </div>
