                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="../images/yureka/1.jpg" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/yureka/2.png" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/yureka/3.jpg" alt="Home applicances">
                                </div>
                            </div>
...
<div="row">
    ...
    <div id="image" >
    <h1>YU Yureka Plus-</h1> 
        <img src="../images/spec/yureka.png">
    </div>
<div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="yureka.php">
                              </div>
