                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" style="max-height:400px; min-height:400px;">
                                <div class="item active">
                                    <img class="slide-image" src="../images/820/1.jpg" style="max-height:400px; min-height:400px; max-width:900px; min-width:940px;" alt="mobile">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/820/2.jpg" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;" alt="camera">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="../images/820/3.jpg" style="max-height:400px; min-height:400px;max-width:900px; min-width:940px;" alt="Home applicances">
                                </div>
                            </div>
  ...
  <div class="row">
          <form class="form-inline" action="../new.php" method="post" style="margin-top:50px;" align="center">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="hidden" name="poll" value="820.php">
                              </div>
